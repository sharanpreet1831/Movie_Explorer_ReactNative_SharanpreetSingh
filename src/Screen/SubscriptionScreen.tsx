...
import { Image, SafeAreaView, ScrollView, StyleSheet, ToastAndroid,Text, TouchableOpacity, View, Alert } from 'react-native';
...
//         name: 'Basic',
//         price: '$9.99',
//         features: ['HD Streaming', '1 Device', 'Standard Content'],
//       },
//       {
//         name: 'Standard',
//         price: '$14.99',
//         features: ['HD Streaming', '2 Devices', 'Premium Content', 'Offline Access'],
//       },
//       {
//         name: 'Premium',
//         price: '$19.99',
//         features: ['4K Streaming', '4 Devices', 'Premium Content', 'Offline Access', 'Ad-Free'],
//       },
//     ];
//     setPlandata(plans);
//   }, []);
...
//   useEffect(() => {
//     const transformedPlans = PlanData.Plan.map((plan) => ({
